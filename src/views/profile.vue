                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <label class="form-label"
                      ><i class="fab fa-fw fa-facebook me-2 text-facebook"></i>Facebook *</label
                    >
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div class="col-md-6">
                    <label class="form-label"
                      ><i class="fab fa-fw fa-twitter text-twitter me-2"></i>Twitter *</label
                    >
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div class="col-md-6">
                    <label class="form-label"
                      ><i class="fab fa-fw fa-line text-line me-2"></i>Line *</label
                    >
                    <input
                      type="text"
                      class="form-control"
                      placeholder=""
                      aria-label="Line"
                      value="http://www.line.com"
                    />
                  </div>
                  <!-- Instragram -->
                  <div class="col-md-6">
                    <label class="form-label"
                      ><i class="fab fa-fw fa-instagram text-instagram me-2"></i>Instagram *</label
                    >
                    <input
                      type="text"
                      class="form-control"
